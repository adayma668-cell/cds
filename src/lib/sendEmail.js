...
export async function sendPasswordResetEmail({ to, name, resetLink }) {
  ...
  const msg = {
    ...
    subject: "Reset your cSU password",
    html: `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
        ...
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width: 520px; width: 100%;">
          ...
          <tr>
            <td style="background-color: #ffffff; border: 1px solid #d4e4dc; border-radius: 16px; padding: 40px 32px; text-align: center;">
              ...
              <p style="color: #5f7a6e; font-size: 15px; line-height: 1.6; margin: 0 0 32px 0;">
                We received a request to reset your password on <strong style="color: #1a2332;">cSU</strong>.<br/>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                <tr>
                  <td align="center" style="background-color: #06c286; border-radius: 12px;">
                    <a href="${resetLink}" target="_blank" style="display: inline-block; background-color: #06c286; color: #ffffff; text-decoration: none; font-weight: 700; font-size: 15px; padding: 16px 40px; border-radius: 12px; letter-spacing: 0.3px; mso-padding-alt: 0; text-align: center;">
                      <!--[if mso]><i style="letter-spacing: 40px; mso-font-width: -100%; mso-text-raise: 30pt;">&nbsp;</i><![endif]-->
